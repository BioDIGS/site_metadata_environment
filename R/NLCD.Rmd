...
## Get coords and NLCS attributes
...
These are the raw, direct outputs from the random forest models before any post-processing is applied.
...
This is the final, post-processed product that undergoes several filtering steps.
